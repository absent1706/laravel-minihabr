...
<div>
  ...
  <ul class="nav nav-pills nav-justified link-list-justified">
    ...
    <li class="{{ ($sort == 'most-starred')   ? 'active' : '' }}"><a href="{{ route('articles.index', array_merge($appendQuery, ['sort' => 'most-starred']))   }}"><span class="glyphicon glyphicon-star"    ></span>Most starred</a></li>
  </ul>
</div>
